...
const UpdatePlace = () =>{
    ...
    /*setting the initial data of input field as null */ 
    const [formState, inputHandler, setFormData] = useForm({
        ...
        /*fetching data for the particular id from database*/ 
        useEffect(()=>{
   ...
   return(
    ...
    <ErrorModal error={error} onClear={clearError}/>
        ...
        /*onInput is taking id, value and isValid as input*/  
        /*id is automatically given as parameter */ 
        /*value and isValid are taken from input fields than validated than provided as parameters */ 
